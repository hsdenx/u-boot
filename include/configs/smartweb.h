...
#define CONFIG_SPL_STACK_R		CONFIG_SYS_TEXT_BASE
#else
/*
...
#else
/* for old u-boot in nand flash */
#define	CONFIG_SYS_NAND_U_BOOT_START	0x23f00000
#define CONFIG_SYS_NAND_U_BOOT_DST	0x23f00000
#endif
